...
static void DisplayMessage(std::string_view msg) {
  // MessageBox(NULL, msg.data(), "DirectDrawSurface_null", MB_OK);
}
...
HRESULT __stdcall OglSurface_GetAttachedSurface(OglDirectDrawSurface* This, LPDDSCAPS2,
                                                LPDIRECTDRAWSURFACE7 FAR* surface) {
  DisplayMessage("GetAttachedSurface");
  *surface = (LPDIRECTDRAWSURFACE7)This;
  return S_OK;
}
